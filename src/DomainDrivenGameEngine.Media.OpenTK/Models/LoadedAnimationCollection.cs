...
namespace DomainDrivenGameEngine.Media.OpenTK.Models
{
    ...
    /// </summary>
    public class LoadedAnimationCollection : ReadOnlyCollection<Animation>, IMediaImplementation<AnimationCollection>
    {
        /// <summary>
        /// The animations in this collection keyed by name.
        /// </summary>
        private readonly IDictionary<string, Animation> _animationsByName;
        ...
        public LoadedAnimationCollection(IList<Animation> animations)
        ...
        public bool TryGetAnimationByName(string name, out Animation outputAnimation)
        {
